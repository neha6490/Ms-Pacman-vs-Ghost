...
public class BFS_Controller extends Controller<MOVE> {
	...
	/*
	 * public enum MOVE { UP { public MOVE opposite(){return MOVE.DOWN; };},
	 * RIGHT { public MOVE opposite(){return MOVE.LEFT; };}, DOWN { public MOVE
	 * opposite(){return MOVE.UP; };}, LEFT { public MOVE opposite(){return
	 * MOVE.RIGHT; };}, NEUTRAL { public MOVE opposite(){return MOVE.NEUTRAL;
	 * };};
	 * 
